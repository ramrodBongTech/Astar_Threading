...
void Renderer::drawEmptyRect(const Rect& r, const Colour& c)
{
	SDL_SetRenderDrawColor(sdl_renderer, c.r, c.g, c.b, c.a);
	SDL_Rect sr;
	sr.h = (int)r.size.h;
...
void Renderer::drawEmptyWorldRect(const Rect &r, const Colour &c)
{
	drawEmptyRect(worldToScreen(r), c);
}
...
void Renderer::clear(const Colour& c) 
{
	SDL_SetRenderDrawColor(sdl_renderer, c.r, c.g, c.b, c.a);
